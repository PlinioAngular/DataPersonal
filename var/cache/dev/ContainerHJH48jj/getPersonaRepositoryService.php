...
// Returns the private 'App\Repository\PersonaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PersonaRepository.php';

return $this->privates['App\\Repository\\PersonaRepository'] = new \App\Repository\PersonaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
