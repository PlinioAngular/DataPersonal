...
return [
    ...
    [ // $dynamicRoutes
        ...
        185 => [[['_route' => 'perfil', '_controller' => 'App\\Controller\\PerfilController::perfil'], ['id'], ['GET' => 0, 'POST' => 1], null, false, true, null]],
        222 => [[['_route' => 'fos_user_registration_confirm', '_controller' => 'fos_user.registration.controller:confirmAction'], ['token'], ['GET' => 0], null, false, true, null]],
        252 => [
