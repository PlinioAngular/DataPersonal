...
class __TwigTemplate_765bd1efdfb04a509f6c527877b8368f6f630c8153c409d7cca2182f82305d1f extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["id"] ?? null)]);
    ...
    public function block_form_rows($context, array $blocks = [])
    {
        ...
        // line 410
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_array_filter(($context["form"] ?? null), function ($__child__) use ($context, $macros) { $context["child"] = $__child__; return  !twig_get_attribute($this->env, $this->source, $context["child"], "rendered", [], "any", false, false, false, 410); }));
        foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
            // line 411
            echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($context["child"], 'row');
        }
...
$context["attrvalue"] === false)) {
    ...
    {
        return new Source("", "form_div_layout.html.twig", "C:\\wamp64\\www\\html\\datospersonal.sattelital.com.pe\\vendor\\symfony\\twig-bridge\\Resources\\views\\Form\\form_div_layout.html.twig");
    }
}
